<template>
  <div>
    <div class="bg-gray-100 min-w-screen min-h-screen justify-center">
      <section class="mt-24 m-auto flex justify-center items-center flex-col">
        <svg
          class="emoji-404"
        ...
        <div
          class="tracking-widest mt-4 flex flex-col items-center justify-center"
        >
          <span class="text-gray-500 text-6xl block"><span>5 0 0</span></span>
